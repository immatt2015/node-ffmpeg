...
// 		}
	 ...
	 */
	this.fnExtractFrameToJPG = this.fnExtractFrameToImage;
	this.fnExtractFrameToImage = function (/* destinationFolder, settings, callback */) {
		...
		settings.file_name = path.basename(settings.file_name, path.extname(settings.file_name)) + '_%d.' + settings.prefix;
